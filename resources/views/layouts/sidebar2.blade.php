...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-gray-100 relative lg:flex" x-data="{ open: false }">
        <aside
            class="w-64 z-10 h-screen lg:transform-none lg:opacity-100 bg-white fixed inset-0 transform duration-200 lg:relative shadow"
        ...
        <div class="w-full space-y-4">
            <nav class="bg-white border-gray-200 px-2 lg:px-4 py-2.5 dark:bg-gray-800 w-full h-14 shadow-sm">
