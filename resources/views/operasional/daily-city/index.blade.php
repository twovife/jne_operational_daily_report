<x-sidebar-layout>
    ...
    <div class="rounded bg-white dark:bg-gray-800 dark:text-white p-4 w-full">
        ...
        <form action="{{ route('opr.dailyperformance.ctc.index') }}">
    ...
    <div class="rounded bg-white dark:bg-gray-800 dark:text-white p-4 w-full">
        <div class="flex justify-between items-center mb-3">
            <h2 class="text-xl text-gray-900 dark:text-white">
                Performa Delivery CTC
            </h2>
            <div class="flex justify-start space-x-2">
                <x-btn-link :href="route('opr.dailyperformance.ctc.create')">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <form id="exportReport" action="{{ route('opr.dailyperformance.ctc.export') }}" method="GET">
                        ...
                        <tr
                            ...
                            <th scope="row"
                                ...
                                <a class="text-indigo-500 hover:underline focus:text-indigo-700"
                                    href="{{ route('opr.dailyperformance.ctc.edit', $performance->id) }}">
